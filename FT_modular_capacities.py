# -*- coding: utf-8 -*-
"""
Created on Tue Nov 17 13:31:27 2020
...
def flowthinning():
    ...
    c, var_typeInteger, var_type2, var_type3 = configureproblem(data)

    c.solve()

    writeexcelfile(c, var_typeInteger, var_type2, var_type3)

def writeexcelfile(c, var_typeInteger, var_type2, var_type3):
...
def configureproblem(data):
    ...
    return c, var_typeInteger, var_type2, var_type3
